...
class PaymentApplicationServiceTest {
    ...
    private void stubPreRecord(boolean methodActive) {
        given(paymentChargeService.preRecord(RESERVATION_ID, STAFF_MEMBER_ID, DRAFT_TOKEN)).willReturn(
    ...
    void approveSuccess_paid() {
        ...
        PaymentChargeResponse response = paymentApplicationService.charge(RESERVATION_ID, STAFF_MEMBER_ID, DRAFT_TOKEN);
    ...
    void backoffDeadlineCap_stopsRetryingEarly() {
        ...
        PaymentChargeResponse response = service.charge(RESERVATION_ID, STAFF_MEMBER_ID, DRAFT_TOKEN);
    ...
    void approvePaidWithAmountMismatch_pending() {
        ...
        PaymentChargeResponse response = serviceWith(gateway).charge(RESERVATION_ID, STAFF_MEMBER_ID, DRAFT_TOKEN);
