...
public class PaymentApplicationService {
     ...
     */
    public PaymentChargeResponse charge(Long reservationId, Long staffMemberId) {
        // Tx1 — 검증 + 초안 항목 스탬프 + PENDING 선기록(커밋).
        PaymentPreRecord pre = paymentChargeService.preRecord(reservationId, staffMemberId);
