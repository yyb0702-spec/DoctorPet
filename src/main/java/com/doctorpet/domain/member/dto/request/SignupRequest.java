...
public record SignupRequest(
        ...
        // 하이픈 유무 둘 다 허용하되(010-1234-5678 / 01012345678), 두 하이픈 자리가 각각
        // 독립적인 "-?"면 "010-12345678"·"0101234-5678"처럼 한쪽만 있는 값도 통과해버린다
        // (리뷰 지적) — 두 자리 모두 있거나 둘 다 없는 경우만 허용하도록 통째로 두 갈래로
        // 나눴다. 010·011·016~019만 허용.
        @NotBlank(message = "전화번호는 필수입니다.")
        @Pattern(regexp = "^01(?:0|1|[6-9])(?:-\\d{3,4}-\\d{4}|\\d{3,4}\\d{4})$", message = "전화번호 형식이 올바르지 않습니다. (예: 010-1234-5678)")
        String phone
) {
}
