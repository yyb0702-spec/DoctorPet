...
| type | VARCHAR | RESERVATION_REQUESTED / RESERVATION_CONFIRMED / RESERVATION_REJECTED / RESERVATION_HOSPITAL_CANCELED / RESERVATION_WAITLIST_OFFERED / PAYMENT_RESULT / PAYMENT_PENDING / NO_SHOW |
